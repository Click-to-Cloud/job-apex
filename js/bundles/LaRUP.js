...
var LaRUP = function (_Component) {
  _inherits(LaRUP, _Component);

  function LaRUP() {
    _classCallCheck(this, LaRUP);

    return _possibleConstructorReturn(this, (LaRUP.__proto__ || Object.getPrototypeOf(LaRUP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LaRUP, _indexSoy2.default);

exports.default = LaRUP;
...
exports.templates = exports.LaRUP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LaRUP.
   * @public
   */

  goog.module('LaRUP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LaRUP.render';
  }
...
_metalSoy2.default.register(LaRUP, templates);
exports.LaRUP = LaRUP;
