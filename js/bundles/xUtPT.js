...
var xUtPT = function (_Component) {
  _inherits(xUtPT, _Component);

  function xUtPT() {
    _classCallCheck(this, xUtPT);

    return _possibleConstructorReturn(this, (xUtPT.__proto__ || Object.getPrototypeOf(xUtPT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xUtPT, _step_6Soy2.default);

exports.default = xUtPT;
...
exports.templates = exports.xUtPT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace xUtPT.
   * @public
   */

  goog.module('xUtPT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'xUtPT.render';
  }
...
_metalSoy2.default.register(xUtPT, templates);
exports.xUtPT = xUtPT;
