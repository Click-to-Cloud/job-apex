...
var oUfUK = function (_Component) {
  _inherits(oUfUK, _Component);

  function oUfUK() {
    _classCallCheck(this, oUfUK);

    return _possibleConstructorReturn(this, (oUfUK.__proto__ || Object.getPrototypeOf(oUfUK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(oUfUK, _step_4Soy2.default);

exports.default = oUfUK;
...
exports.templates = exports.oUfUK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace oUfUK.
   * @public
   */

  goog.module('oUfUK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'oUfUK.render';
  }
...
_metalSoy2.default.register(oUfUK, templates);
exports.oUfUK = oUfUK;
