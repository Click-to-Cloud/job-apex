...
var PDtsu = function (_Component) {
  _inherits(PDtsu, _Component);

  function PDtsu() {
    _classCallCheck(this, PDtsu);

    return _possibleConstructorReturn(this, (PDtsu.__proto__ || Object.getPrototypeOf(PDtsu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PDtsu, _indexSoy2.default);

exports.default = PDtsu;
...
exports.templates = exports.PDtsu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PDtsu.
   * @public
   */

  goog.module('PDtsu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PDtsu.render';
  }
...
_metalSoy2.default.register(PDtsu, templates);
exports.PDtsu = PDtsu;
