...
var zpseB = function (_Component) {
  _inherits(zpseB, _Component);

  function zpseB() {
    _classCallCheck(this, zpseB);

    return _possibleConstructorReturn(this, (zpseB.__proto__ || Object.getPrototypeOf(zpseB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zpseB, _step_4Soy2.default);

exports.default = zpseB;
...
exports.templates = exports.zpseB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zpseB.
   * @public
   */

  goog.module('zpseB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zpseB.render';
  }
...
_metalSoy2.default.register(zpseB, templates);
exports.zpseB = zpseB;
