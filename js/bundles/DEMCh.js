...
var DEMCh = function (_Component) {
  _inherits(DEMCh, _Component);

  function DEMCh() {
    _classCallCheck(this, DEMCh);

    return _possibleConstructorReturn(this, (DEMCh.__proto__ || Object.getPrototypeOf(DEMCh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DEMCh, _step_4Soy2.default);

exports.default = DEMCh;
...
exports.templates = exports.DEMCh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DEMCh.
   * @public
   */

  goog.module('DEMCh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DEMCh.render';
  }
...
_metalSoy2.default.register(DEMCh, templates);
exports.DEMCh = DEMCh;
