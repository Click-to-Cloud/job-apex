...
var HvxVE = function (_Component) {
  _inherits(HvxVE, _Component);

  function HvxVE() {
    _classCallCheck(this, HvxVE);

    return _possibleConstructorReturn(this, (HvxVE.__proto__ || Object.getPrototypeOf(HvxVE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HvxVE, _step_1Soy2.default);

exports.default = HvxVE;
...
exports.templates = exports.HvxVE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HvxVE.
   * @public
   */

  goog.module('HvxVE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HvxVE.render';
  }
...
_metalSoy2.default.register(HvxVE, templates);
exports.HvxVE = HvxVE;
