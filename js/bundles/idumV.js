...
var idumV = function (_Component) {
  _inherits(idumV, _Component);

  function idumV() {
    _classCallCheck(this, idumV);

    return _possibleConstructorReturn(this, (idumV.__proto__ || Object.getPrototypeOf(idumV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(idumV, _step_1Soy2.default);

exports.default = idumV;
...
exports.templates = exports.idumV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace idumV.
   * @public
   */

  goog.module('idumV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'idumV.render';
  }
...
_metalSoy2.default.register(idumV, templates);
exports.idumV = idumV;
