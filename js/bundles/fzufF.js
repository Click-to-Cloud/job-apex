...
var fzufF = function (_Component) {
  _inherits(fzufF, _Component);

  function fzufF() {
    _classCallCheck(this, fzufF);

    return _possibleConstructorReturn(this, (fzufF.__proto__ || Object.getPrototypeOf(fzufF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fzufF, _cronSoy2.default);

exports.default = fzufF;
...
exports.templates = exports.fzufF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fzufF.
   * @public
   */

  goog.module('fzufF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fzufF.render';
  }
...
_metalSoy2.default.register(fzufF, templates);
exports.fzufF = fzufF;
