...
var ShnpV = function (_Component) {
  _inherits(ShnpV, _Component);

  function ShnpV() {
    _classCallCheck(this, ShnpV);

    return _possibleConstructorReturn(this, (ShnpV.__proto__ || Object.getPrototypeOf(ShnpV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ShnpV, _step_2Soy2.default);

exports.default = ShnpV;
...
exports.templates = exports.ShnpV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ShnpV.
   * @public
   */

  goog.module('ShnpV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ShnpV.render';
  }
...
_metalSoy2.default.register(ShnpV, templates);
exports.ShnpV = ShnpV;
