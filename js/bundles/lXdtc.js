...
var lXdtc = function (_Component) {
  _inherits(lXdtc, _Component);

  function lXdtc() {
    _classCallCheck(this, lXdtc);

    return _possibleConstructorReturn(this, (lXdtc.__proto__ || Object.getPrototypeOf(lXdtc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lXdtc, _cronSoy2.default);

exports.default = lXdtc;
...
exports.templates = exports.lXdtc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace lXdtc.
   * @public
   */

  goog.module('lXdtc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'lXdtc.render';
  }
...
_metalSoy2.default.register(lXdtc, templates);
exports.lXdtc = lXdtc;
