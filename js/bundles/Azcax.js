...
var Azcax = function (_Component) {
  _inherits(Azcax, _Component);

  function Azcax() {
    _classCallCheck(this, Azcax);

    return _possibleConstructorReturn(this, (Azcax.__proto__ || Object.getPrototypeOf(Azcax)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Azcax, _step_5Soy2.default);

exports.default = Azcax;
...
exports.templates = exports.Azcax = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Azcax.
   * @public
   */

  goog.module('Azcax.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Azcax.render';
  }
...
_metalSoy2.default.register(Azcax, templates);
exports.Azcax = Azcax;
