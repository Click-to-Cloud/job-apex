...
var JtwPy = function (_Component) {
  _inherits(JtwPy, _Component);

  function JtwPy() {
    _classCallCheck(this, JtwPy);

    return _possibleConstructorReturn(this, (JtwPy.__proto__ || Object.getPrototypeOf(JtwPy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JtwPy, _step_5Soy2.default);

exports.default = JtwPy;
...
exports.templates = exports.JtwPy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JtwPy.
   * @public
   */

  goog.module('JtwPy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JtwPy.render';
  }
...
_metalSoy2.default.register(JtwPy, templates);
exports.JtwPy = JtwPy;
