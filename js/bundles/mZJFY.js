...
var mZJFY = function (_Component) {
  _inherits(mZJFY, _Component);

  function mZJFY() {
    _classCallCheck(this, mZJFY);

    return _possibleConstructorReturn(this, (mZJFY.__proto__ || Object.getPrototypeOf(mZJFY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mZJFY, _repeatingSoy2.default);

exports.default = mZJFY;
...
exports.templates = exports.mZJFY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mZJFY.
   * @public
   */

  goog.module('mZJFY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mZJFY.render';
  }
...
_metalSoy2.default.register(mZJFY, templates);
exports.mZJFY = mZJFY;
