...
var KnyhM = function (_Component) {
  _inherits(KnyhM, _Component);

  function KnyhM() {
    _classCallCheck(this, KnyhM);

    return _possibleConstructorReturn(this, (KnyhM.__proto__ || Object.getPrototypeOf(KnyhM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KnyhM, _step_2Soy2.default);

exports.default = KnyhM;
...
exports.templates = exports.KnyhM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KnyhM.
   * @public
   */

  goog.module('KnyhM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KnyhM.render';
  }
...
_metalSoy2.default.register(KnyhM, templates);
exports.KnyhM = KnyhM;
