...
var vENck = function (_Component) {
  _inherits(vENck, _Component);

  function vENck() {
    _classCallCheck(this, vENck);

    return _possibleConstructorReturn(this, (vENck.__proto__ || Object.getPrototypeOf(vENck)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vENck, _step_6Soy2.default);

exports.default = vENck;
...
exports.templates = exports.vENck = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vENck.
   * @public
   */

  goog.module('vENck.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vENck.render';
  }
...
_metalSoy2.default.register(vENck, templates);
exports.vENck = vENck;
