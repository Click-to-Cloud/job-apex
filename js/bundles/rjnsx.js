...
var rjnsx = function (_Component) {
  _inherits(rjnsx, _Component);

  function rjnsx() {
    _classCallCheck(this, rjnsx);

    return _possibleConstructorReturn(this, (rjnsx.__proto__ || Object.getPrototypeOf(rjnsx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(rjnsx, _step_1Soy2.default);

exports.default = rjnsx;
...
exports.templates = exports.rjnsx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace rjnsx.
   * @public
   */

  goog.module('rjnsx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'rjnsx.render';
  }
...
_metalSoy2.default.register(rjnsx, templates);
exports.rjnsx = rjnsx;
