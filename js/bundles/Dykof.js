...
var Dykof = function (_Component) {
  _inherits(Dykof, _Component);

  function Dykof() {
    _classCallCheck(this, Dykof);

    return _possibleConstructorReturn(this, (Dykof.__proto__ || Object.getPrototypeOf(Dykof)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Dykof, _repeatingSoy2.default);

exports.default = Dykof;
...
exports.templates = exports.Dykof = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Dykof.
   * @public
   */

  goog.module('Dykof.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Dykof.render';
  }
...
_metalSoy2.default.register(Dykof, templates);
exports.Dykof = Dykof;
