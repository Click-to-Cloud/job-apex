...
var jdgpD = function (_Component) {
  _inherits(jdgpD, _Component);

  function jdgpD() {
    _classCallCheck(this, jdgpD);

    return _possibleConstructorReturn(this, (jdgpD.__proto__ || Object.getPrototypeOf(jdgpD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jdgpD, _step_6Soy2.default);

exports.default = jdgpD;
...
exports.templates = exports.jdgpD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jdgpD.
   * @public
   */

  goog.module('jdgpD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jdgpD.render';
  }
...
_metalSoy2.default.register(jdgpD, templates);
exports.jdgpD = jdgpD;
