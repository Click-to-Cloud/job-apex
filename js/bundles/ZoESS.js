...
var ZoESS = function (_Component) {
  _inherits(ZoESS, _Component);

  function ZoESS() {
    _classCallCheck(this, ZoESS);

    return _possibleConstructorReturn(this, (ZoESS.__proto__ || Object.getPrototypeOf(ZoESS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZoESS, _repeatingSoy2.default);

exports.default = ZoESS;
...
exports.templates = exports.ZoESS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZoESS.
   * @public
   */

  goog.module('ZoESS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZoESS.render';
  }
...
_metalSoy2.default.register(ZoESS, templates);
exports.ZoESS = ZoESS;
