...
var kmZJf = function (_Component) {
  _inherits(kmZJf, _Component);

  function kmZJf() {
    _classCallCheck(this, kmZJf);

    return _possibleConstructorReturn(this, (kmZJf.__proto__ || Object.getPrototypeOf(kmZJf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kmZJf, _cronSoy2.default);

exports.default = kmZJf;
...
exports.templates = exports.kmZJf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kmZJf.
   * @public
   */

  goog.module('kmZJf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kmZJf.render';
  }
...
_metalSoy2.default.register(kmZJf, templates);
exports.kmZJf = kmZJf;
