...
var jkuGC = function (_Component) {
  _inherits(jkuGC, _Component);

  function jkuGC() {
    _classCallCheck(this, jkuGC);

    return _possibleConstructorReturn(this, (jkuGC.__proto__ || Object.getPrototypeOf(jkuGC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jkuGC, _step_2Soy2.default);

exports.default = jkuGC;
...
exports.templates = exports.jkuGC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jkuGC.
   * @public
   */

  goog.module('jkuGC.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param698 = function param698() {
      ie_open('h2');
      ...
      ie_close('p');
      ie_open('p');
      itext('Job.apex uses Func objects from R.apex, and a Func is actually a custom Apex object that mimics the behavior of a function.');
      ie_close('p');
      ie_open('p');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jkuGC.render';
  }
...
_metalSoy2.default.register(jkuGC, templates);
exports.jkuGC = jkuGC;
