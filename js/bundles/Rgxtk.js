...
var Rgxtk = function (_Component) {
  _inherits(Rgxtk, _Component);

  function Rgxtk() {
    _classCallCheck(this, Rgxtk);

    return _possibleConstructorReturn(this, (Rgxtk.__proto__ || Object.getPrototypeOf(Rgxtk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Rgxtk, _step_5Soy2.default);

exports.default = Rgxtk;
...
exports.templates = exports.Rgxtk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Rgxtk.
   * @public
   */

  goog.module('Rgxtk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Rgxtk.render';
  }
...
_metalSoy2.default.register(Rgxtk, templates);
exports.Rgxtk = Rgxtk;
